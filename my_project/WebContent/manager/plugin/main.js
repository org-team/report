	 ...
	 */
		$.fn.extend({
			...
			pagination:function(page,func){
				...
				$("<select class='form-control' style='width: 70px'><option>1</option><option>5</option><option>10</option><option>15</option><option>20</option><option>50</option><option>100</option><option>300</option><option>500</option></select>")
				.appendTo(div)
				.val(page.pageCount)
				.change(function(){
					pageCount = $(this).val();
